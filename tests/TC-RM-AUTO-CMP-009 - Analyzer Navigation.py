...
def test_example(page: Page) -> None:
    ...
    page.get_by_text("Release ManagerTEST78Compare").click()
    page.locator("#radix-_r_1tt_").click()
    page.get_by_role("menuitem", name="Analyze Comparison").click()
    page.get_by_text("1103157470").click()
    page.get_by_role("main").get_by_role("button").filter(
