...
def test_example(page: Page) -> None:
    ...
    page.locator("#radix-_r_49_").click()
    page.get_by_role("menuitem", name="Deploy").click()
    page.get_by_role("button", name="Process Deployment").click()
    page.get_by_text("Deployment scheduled").click()
    page.get_by_text("Complete").nth(1).click()
    ...
    page.get_by_role("cell", name="1").first.click()
    page.get_by_text("0", exact=True).first.click()
    page.get_by_text("0", exact=True).nth(1).click()
    page.get_by_text("0", exact=True).nth(2).click()
    page.get_by_text("0", exact=True).nth(3).click()
    page.get_by_text("Matched").click()
    page.get_by_text("To Be Added").click()
    page.get_by_text("To Be Deleted").click()
    page.get_by_text("To Be Updated").click()
    page.get_by_text("Total Changes").click()
