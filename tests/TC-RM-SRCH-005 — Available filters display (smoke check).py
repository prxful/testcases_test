...
def test_example(page: Page) -> None:
    ...
    page.get_by_role("option", name="Sealed").click()
    page.get_by_role("combobox").filter(has_text="+ Add Filter").click()
    page.get_by_label("Requestor").get_by_text("Requestor").click()
    page.get_by_role("textbox", name="Enter requestor name").click()
    page.get_by_role("textbox", name="Enter requestor name").fill(BASE_UNAME)
    page.get_by_role("combobox").filter(has_text="+ Add Filter").click()
    page.get_by_label("Description").get_by_text("Description").click()
    page.get_by_role("textbox", name="Add short description").click()
    page.get_by_role("textbox", name="Add short description").fill("Test by P")
