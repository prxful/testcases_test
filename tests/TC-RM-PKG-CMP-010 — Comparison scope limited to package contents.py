...
def test_example(page: Page) -> None:
    ...
    page.get_by_role("link", name="TEST-GSSS33").click()
    ...
    page.get_by_role("tab", name="Batch Logs").click()
    page.get_by_role("tab", name="Batch Parameters").click()
    page.get_by_text("Comparison Environment").click()
    page.get_by_text("Supress Matches").click()
    page.get_by_role("link", name="PACKAGE_ID").click()
